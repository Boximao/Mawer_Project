...
Accepted agentic RAG demonstration runtime: [`docs/RUNNING_ENVIRONMENT.md`](docs/RUNNING_ENVIRONMENT.md). Parent spec: [`docs/AGENTIC_RAG_SPEC.md`](docs/AGENTIC_RAG_SPEC.md). High-level architecture and repo map: [`docs/TECHNICAL_SOLUTION.md`](docs/TECHNICAL_SOLUTION.md). Demonstration diagrams: [`docs/diagrams/`](docs/diagrams/README.md).
